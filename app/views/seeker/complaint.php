...
$subjects = $seeker->getComplaintSubjectUsers();
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($description)) {
        ...
        if ($seeker->submitComplaint($seekerId, $subjectId, $description)) {
...
$complaints = $seeker->getMyComplaints($seekerId);
?>

<!DOCTYPE html>
<html>
<head>
    <title>Submit Complaint - Job Seeker</title>
...
<div class="seeker-wrapper">
    ...
    <main class="main-content">
        ...
        <p>Report misleading jobs, inappropriate messages, or platform issues.</p>
