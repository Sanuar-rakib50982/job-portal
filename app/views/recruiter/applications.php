...
$applications = $recruiter->getRecruiterApplications($recruiterId);
?>
...
<div class="recruiter-wrapper">
    ...
    <main class="main-content">
        <h1>Applications</h1>
        <p>Review candidate applications and update their hiring pipeline status.</p>
                    ...
                    <?php while ($application = $applications->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-secondary" href="seeker_profile.php?id=<?php echo $application['seeker_id']; ?>">
                                    View Profile
                                </a>
                            </td>

                            <td>
                                <?php echo nl2br(htmlspecialchars($application['cover_letter'] ?? 'No cover letter')); ?>
                            </td>
                            ...
                            <td>
                                ...
                                <span 
                                    ...
                                    id="statusBadge-<?php echo $application['application_id']; ?>">
