...
$subjects = $recruiter->getComplaintSubjectUsers();
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($description)) {
        ...
        if ($recruiter->submitComplaint($recruiterId, $subjectId, $description)) {
...
$complaints = $recruiter->getMyComplaints($recruiterId);
?>

<!DOCTYPE html>
<html>
<head>
    <title>Submit Complaint - Recruiter</title>
