...
if ($jobId > 0) {
    $job = $recruiter->getJobById($jobId, $recruiterId);
...
$categories = $recruiter->getCategories();
$error = "";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($data['category_id'] <= 0) {
        ...
        if ($jobId > 0) {
            if ($recruiter->updateJob($jobId, $recruiterId, $data)) {
            ...
            if ($recruiter->createJob($recruiterId, $data)) {
...
<html>
<head>
    <title><?php echo $jobId > 0 ? "Edit Job" : "Post Job"; ?> - Recruiter</title>
...
<div class="recruiter-wrapper">
    ...
    <main class="main-content">
        ...
        <p>Fill in the job information carefully.</p>
